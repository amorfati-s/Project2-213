        ...
        while (hasNextLine) {
            ...
            switch (command) {
                ...
                case "S": // handling setHours command for part time employee
                    ...
                    Parttime setHrsEmp = new Parttime(setHrsProfile, hours); // i want to pass in the double for hours
                                                                             // and manipulate this into the setHours
                                                                             // method
                    ...
                    if (hours < 100) {
                        ...
                        if (companyDB.setHours(setHrsEmp)) {// so this part time employee has to be found first in the
                                                            // method, and then we have to
